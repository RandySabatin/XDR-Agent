...
#define DEFAULT_CONFIG_FILENAME L"LogMonitorConfig.json"

#define JSON_TAG_LOGSQUEUESENDER L"LogsQueueSender"
#define JSON_TAG_SENDINTERVAL L"send_interval"
#define JSON_TAG_SENDLMAXEVENT L"send_max_event"
#define JSON_TAG_SENDFOLDERPATH L"send_folderpath"
#define JSON_TAG_SENDURLPATH L"send_urlpath"

#define JSON_TAG_LOGSQUEUE L"LogsQueue"
#define JSON_TAG_QUEUEMAXEVENT L"queue_max_event"

#define JSON_TAG_LOG_CONFIG L"LogHandler"
...
typedef struct _LoggerSettings
{
    ...
    std::wstring SendLocalPath = L"";
    std::wstring SendURLPath = L"";
    unsigned int SendInterval = 5;
    unsigned int Max_send_events = 500;
    unsigned int Max_queue_events = 5000;
